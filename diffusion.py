...
def home():
    return """
        <html>
            ...
            <body>
                <h1 style="text-align: center;">Je suis Israa Aouifi, étudiante en PIC 12</h1>
                <p style="text-align: center;">Voici le calcul du coefficient de diffusion et l'erreur.</p>
